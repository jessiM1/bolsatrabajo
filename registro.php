...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO buscadores (nombre, apaterno, amaterno, direccion, fn, edad, correo, telefono, pass) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssss", $nombre, $apaterno, $amaterno, $direccion, $fn, $edad, $correo, $telefono, $pass);
    $stmt->execute();
     ...
     <div class="services_main">
        ...
        <div class="parent-container">
                    ...
                    <form method="POST" action="" class="form-horizontal">
                        ...
                        <div class="header">Registro Usuario</div>
                        <div class="form-content">
                           <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="col-sm-12">
                            <input type="text" name="apaterno" placeholder="Apellido Paterno" required class="form-control">
                                </div>
                            </div>
                            
                             <div class="form-group">
                                <div class="col-sm-12">
                           <input type="text" name="amaterno" placeholder="Apellido Materno" required class="form-control"> 
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                <div class="col-sm-12">
                                   <input type="date" id="fn" name="fn" placeholder="Fecha de Nacimiento" required onchange="calcularEdad();" class="form-control">
                                </div>
                            </div>
                            
                             <div class="form-group">
                                <div class="col-sm-12">
                                <input type="text" id="edad" name="edad" placeholder="Edad" required  readonly class="form-control"> 
                                </div>
                            </div>
                            ...
                            <button type="submit" style="display: block; margin: 0 auto;" class="read_more">Registrarse</button>
                    </form>
      ...
      <!-- Javascript files-->
       <script>
        function calcularEdad() {
            ...
            const fnValue = new Date(fnInput.value);
            const today = new Date();
            let edad = today.getFullYear() - fnValue.getFullYear();
            const m = today.getMonth() - fnValue.getMonth();

            if (m < 0 || (m === 0 && today.getDate() < fnValue.getDate())) {
                edad--;
            }
